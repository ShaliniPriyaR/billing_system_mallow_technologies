class InvoiceItemsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @invoice_item.update(invoice_item_params)
        format.html { redirect_to @invoice_item, notice: "Invoice item was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to invoice_items_path, notice: "Invoice item was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def invoice_item_params
      params.expect(invoice_item: [ :purchase_invoice_id, :product_id, :quantity, :unit_price, :tax_percentage ])
    end
end
