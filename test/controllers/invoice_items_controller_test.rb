...
class InvoiceItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_item" do
    assert_difference("InvoiceItem.count") do
      post invoice_items_url, params: { invoice_item: { product_id: @invoice_item.product_id, purchase_invoice_id: @invoice_item.purchase_invoice_id, quantity: @invoice_item.quantity, tax_percentage: @invoice_item.tax_percentage, unit_price: @invoice_item.unit_price } }
    end
  ...
  test "should update invoice_item" do
    patch invoice_item_url(@invoice_item), params: { invoice_item: { product_id: @invoice_item.product_id, purchase_invoice_id: @invoice_item.purchase_invoice_id, quantity: @invoice_item.quantity, tax_percentage: @invoice_item.tax_percentage, unit_price: @invoice_item.unit_price } }
